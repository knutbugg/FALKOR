...
class TheTerminal:
	...
	def __init__(self):
		...
		self.portfolio = Portfolio(paper_trader=True)
		self.gekko = Gekko(self.portfolio)

		# Add ETHBTC as a security 
		cnn_strat = CNN_Strategy(weights_path='models/cnn/weights/', image_path='models/cnn/images/')
		api_wrapper = BinanceWrapper(client_id='nBjgb83VMNvqq45b3JdWUIsJDalWlXxHI2bvDz9oLdW7KgOLPvJCp30CHnthjfNJ',
	...
	def add_security_to_portfolio(name, time_period, strategy, api_wrapper):
